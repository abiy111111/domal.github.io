...
import 'buatLaporan.dart';

class DetailKampanyePengelola extends StatefulWidget {
 final String title;
 final String image;
 final int collected;
 final int target;
 ...
 @override
 _DetailKampanyePengelolaState createState() => _DetailKampanyePengelolaState();
}

class _DetailKampanyePengelolaState extends State<DetailKampanyePengelola> {
 String _selectedStatus = 'Pengumpulan Dana';
                   ...
                   Container(
                     ...
                     child: Column(
                       ...
                       children: [
                         ...
                         Text(
                           formatToRupiah(widget.collected),
                           style: const TextStyle(
                             fontWeight: FontWeight.bold,
                             fontSize: 14,
                           ),
                   ...
                   Container(
                     ...
                     child: Column(
                       ...
                       children: [
                         ...
                         // Conditional report button for completed donations
if (_selectedStatus == 'Donasi Telah Disalurkan')
  Padding(
    ...
    child: OutlinedButton(
      ...
      style: OutlinedButton.styleFrom(
        side: const BorderSide(color: Color(0xFF086F4A), width: 2),
        foregroundColor: const Color(0xFF086F4A),
